...
extern const byte menu_pressure[];
extern const byte menu_gyrocope[];
...
extern const byte menu_heart[];
extern const byte menu_letter[];
extern const byte T_BMP1[];
extern const byte T_BMP2[];
extern const byte T_BMP3[];
extern const byte T_BMP4[];
extern const byte T_BMP5[];
extern const byte T_BMP6[];
extern const byte T_BMP7[];
extern const byte T_BMP8[];
extern const byte T_BMP9[];
extern const byte T_BMP10[];
